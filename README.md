...
- Bayesian optimization using a Gaussian process prior, see the tutorial on *Gradient boosting regression using XGBoost* and *Gradient boosting classification using XGBoost* below.
